...
![choosing the jladown R Markdown document template after the New File -> R Markdown dialogue](choosing-jla-template.png)

## Using the template

We provide an overview of using the template here; see the template for more 
specific details.
